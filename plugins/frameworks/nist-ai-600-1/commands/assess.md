...
A prioritized gap report listing unmet NIST AI 600-1 requirements, severity-tagged and grouped by SCF family. The report maps back to the 250 framework-native controls via the SCF crosswalk.
